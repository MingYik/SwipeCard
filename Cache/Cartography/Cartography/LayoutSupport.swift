...
import Foundation
    ...
    public extension UIViewController {
        var car_topLayoutGuide : LayoutSupport {
            get {
                return LayoutSupport(layoutGuide: self.view.safeAreaLayoutGuide.topAnchor as! UILayoutSupport)
            }
        }
        
        var car_bottomLayoutGuide : LayoutSupport {
            get {
                return LayoutSupport(layoutGuide: self.view.safeAreaLayoutGuide.bottomAnchor as! UILayoutSupport)
            }
        }
    }
