...
class ZLSwipeableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        constrain(swipeableView, view) { view1, view2 in
            view1.left == view2.left+15
            view1.right == view2.right-15
            view1.top == view2.top + 150
            view1.bottom == view2.bottom - 630
        }
    }
    ...
    func colorForName(_ name: String) -> UIColor {
        ...
        let selector = UIColor.flatColorMethods["flat\(sanitizedName)Color"]
        return (selector ?? UIColor.white)
    }
}
